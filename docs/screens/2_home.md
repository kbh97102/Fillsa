...
| Prompt response | `2929:13630` | established question placeholder, 200-grapheme answer input/count, date/question-keyed local draft handoff and save/load through Typing | `HomePromptAnswerSection` | 부분 통과(빌드·DataStore test) |
